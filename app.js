      ...
      if(!err && usuario){
        ...
        if(usuario.status){
          if(req.body.password == usuario.password){ // si el password coincide
            ...
            res.render("login",{alertPassword:true,alertUsername:false,usuario:false,alertStatus:false});
          }
        ...
        res.render("login",{alertUsername:true,alertPassword:false,usuario:false,alertStatus:false});
